import { MAX_ROOM_FEEDBACKS, MAX_STARS_IN_REEDBACK, CITES_IN_LOGIN_PAGES, START_INDEX_RANDOM_CITY } from './const';
...
export function getRandomCity () : string {
  return CITES_IN_LOGIN_PAGES[random(START_INDEX_RANDOM_CITY, CITES_IN_LOGIN_PAGES.length - 1)];
}
