          ...
          <div className="near-places__list places__list">
            <article className="near-places__card place-card">
              <div className="near-places__image-wrapper place-card__image-wrapper">
                <a href="#todo">
                  <img className="place-card__image" src="img/room.jpg" width="260" height="200" alt="smthing"/>
                </a>
              </div>
            ...
            <article className="near-places__card place-card">
              <div className="near-places__image-wrapper place-card__image-wrapper">
                <a href="#todo">
                  <img className="place-card__image" src="img/apartment-02.jpg" width="260" height="200" alt="smthing"/>
                </a>
              </div>
              <div className="place-card__info">
                <div className="place-card__price-wrapper">
            ...
            <article className="near-places__card place-card">
              ...
              <div className="near-places__image-wrapper place-card__image-wrapper">
                <a href="#todo">
                  <img className="place-card__image" src="img/apartment-03.jpg" width="260" height="200" alt="smthing"/>
                </a>
              </div>
              <div className="place-card__info">
                <div className="place-card__price-wrapper">
