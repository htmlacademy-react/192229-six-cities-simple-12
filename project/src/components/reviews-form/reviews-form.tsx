  ...
  return (
    ...
    >
      ...
      <div className="reviews__rating-form form__rating">
        ...
        <input onChange={fieldChangeHandle} checked={formData.rating === '4'} className="form__rating-input visually-hidden" name="rating" value="4" id="4-stars" type="radio"/>
        ...
        <input onChange={fieldChangeHandle} checked={formData.rating === '3'} className="form__rating-input visually-hidden" name="rating" value="3" id="3-stars" type="radio"/>
        ...
        <input onChange={fieldChangeHandle} checked={formData.rating === '2'} className="form__rating-input visually-hidden" name="rating" value="2" id="2-stars" type="radio"/>
        ...
        <input onChange={fieldChangeHandle} checked={formData.rating === '1'} className="form__rating-input visually-hidden" name="rating" value="1" id="1-star" type="radio"/>
